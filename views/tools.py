...
_TOOL_CATALOG = [
    ...
    ('/tools/carve',         '파일 카빙',        '디스크 이미지에서 파일 시그니처 복구',       '기본',         '#a78bfa', 'bi-file-earmark-binary',  False, 'carve recovery 복구'),
    ...
    # 다운로드 허브
    ('/tools/scripts',       '로컬 스크립트',    '8종 다운로드 (RAM·USB·트리아지)',            '다운로드',     '#f59e0b', 'bi-download',             False, 'local script download'),
